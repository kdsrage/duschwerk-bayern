...
function Slideshow({ projects }) {
  ...
  const go = useCallback((dir) => {
    ...
    setActiveArrow(dir)
    setTimeout(() => setActiveArrow(null), 320)
    setAnimDir(dir)
    setPhase('exiting')
    setTimeout(() => {
  ...
  const exitX  = animDir === 'right' ? '-40px' : '40px'
  const enterAnim = animDir === 'right' ? 'slide-in-right' : 'slide-in-left'
      ...
      >
        ...
        <div
          style={{
            ...
            transform: phase === 'exiting' ? `translateX(${exitX})` : 'translateX(0)',
            transition: phase === 'exiting'
              ? 'opacity 0.20s cubic-bezier(0.4,0,1,1), transform 0.22s cubic-bezier(0.4,0,1,1)'
              : 'none',
            animation: phase === 'entering'
              ? `${enterAnim} 0.34s cubic-bezier(0.22,1,0.36,1) both`
              : 'none',
          }}
          key={slideKey}
        >
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M11 14L6 9l5-5" stroke={activeArrow === 'left' ? '#C62828' : '#1F2E4A'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ transition: 'stroke 0.3s ease' }}/>
            </svg>
          </button>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M7 4l5 5-5 5" stroke={activeArrow === 'right' ? '#C62828' : '#1F2E4A'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ transition: 'stroke 0.3s ease' }}/>
            </svg>
          </button>
        </div>
